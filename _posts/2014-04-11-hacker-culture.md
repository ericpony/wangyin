...
1.    VIM 与 Emacs，选择 VIM
2.    Emacs 与 IntelliJ（编辑 Java），选择 Emacs
3.    组合键与方向键（移动光标），选择组合键，因为“并不是每个键盘都有方向键的！”
4.    Linux 与 Windows，Mac，选择 Linux
5.    Gentoo 与 Ubuntu，选择 Gentoo
6.    Terminal 与 GUI，选择 Terminal，使用黑底绿字
7.    TeX 与 Word，选择 TeX，拒收 .docx 附件
8.    C++ 与 Java，选择 C++
...
<center><p><img src="http://www.yinwang.org/images/the_fucking_manual.png" width="400px" /></p></center>
